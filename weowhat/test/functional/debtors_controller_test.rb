...
class DebtorsControllerTest < ActionController::TestCase
  ...
  test "should create debtor" do
    assert_difference('Debtor.count') do
      post :create, debtor: { payment_id: @debtor.payment_id, user_id: @debtor.user_id, weighting: @debtor.weighting }
    end
  ...
  test "should update debtor" do
    put :update, id: @debtor, debtor: { payment_id: @debtor.payment_id, user_id: @debtor.user_id, weighting: @debtor.weighting }
    assert_redirected_to debtor_path(assigns(:debtor))
  end
