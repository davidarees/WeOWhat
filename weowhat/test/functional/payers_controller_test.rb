...
class PayersControllerTest < ActionController::TestCase
  ...
  test "should create payer" do
    assert_difference('Payer.count') do
      post :create, payer: { payment_id: @payer.payment_id, user_id: @payer.user_id, weighting: @payer.weighting }
    end
  ...
  test "should update payer" do
    put :update, id: @payer, payer: { payment_id: @payer.payment_id, user_id: @payer.user_id, weighting: @payer.weighting }
    assert_redirected_to payer_path(assigns(:payer))
  end
