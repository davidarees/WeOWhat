...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { payment_id: @recipient.payment_id, user_id: @recipient.user_id, weighting: @recipient.weighting }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { payment_id: @recipient.payment_id, user_id: @recipient.user_id, weighting: @recipient.weighting }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
